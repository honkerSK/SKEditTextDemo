//
//  UIView+SKContinueFirstResponder.m
//  SKEditTextDemo
//
...
@implementation UIView (SKContinueFirstResponder)

- (void)setTagIdentity:(NSString *)tagIdentity {
    objc_setAssociatedObject(self, @"skTagIdentity", tagIdentity, OBJC_ASSOCIATION_COPY_NONATOMIC);
}

- (NSString *)tagIdentity {
    return objc_getAssociatedObject(self, @"skTagIdentity");
}
...
- (void)skContinueFirstResponderAndExecuteCode:(void (^)(UIViewResponderHelper *nextResponder))code {
    // 1
