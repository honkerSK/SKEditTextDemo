//
//  UIView+SKContinueFirstResponder.h
//  SKEditTextDemo
//
...
@interface UIView (SKContinueFirstResponder)
...
/**
 ...
 如果确定是scrollview 如tableivew或者collectionview，则最好直接使用[tableview skContinueFirstResponderAndExecuteCode]来刷新，这样获取界面的可响应者时，效率更高
